...
const Get = () =>
{
    ...
    return (
        <div>
            ...
            <p>{ getPost != null && getPost.current.condition != null && getPost.current.condition.temp_f != null && getPost.current.condition.temp_f ? getPost.current.condition.temp_f : undefined }</p>
            {/* <p>{getPost.map((i) =>
            {
                return (
                    <p>{i }</p>
