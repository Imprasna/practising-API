...
const Get = () =>
{
    ...
    return (
        <div>
            ...
            <img>{ getPost != null && getPost.current.condition != null && getPost.current.condition.icon != null && getPost.current.condition.icon ? getPost.current.condition.icon : undefined }</p>
            {/* <p>{getPost.map((i) =>
            {
                return (
                    <p>{i }</p>
