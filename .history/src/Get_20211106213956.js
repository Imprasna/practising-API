...
const Get = () =>
{
    ...
    return (
        <div>
            ...
            <p> <img>{ getPost != null && getPost.current != null && getPost.current.condition.text != null && getPost.current.condition.text ? getPost.current.condition.text : undefined }</img></p>
