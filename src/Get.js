...
const Get = () => {
	...
	const getData = async () => {
		...
		try {
			const res = await axios.get(`https://cors-anywhere.herokuapp.com/http://api.weatherapi.com/v1/current.json?key=b572a200fc624a6a85671436211310&q=${city}&aqi=yes`);
	...
	return (
		<>
            ...
            <div className="whole">
                ...
                <div className="ws">
                <h1>Wind Speed (<sup>kph</sup>)</h1>
                <WindSpeed CName={getPost} />
                </div>

                <div className="uv">
                <h1>UV Ray (<sup>mW/cm2</sup>)</h1>
                    <Uv CName={getPost} />
                </div>
